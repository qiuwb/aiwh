...
@Entity
public class AdTemp extends Model {
    ...
    // ~~~~~~~~~~~~ 
    //构造，入库：
    public AdTemp( long adtypeid,String adname,long advertiserid) {
    ...
    //根据 adtypeid 查找
	public static List<AdTemp> findByAdtypeid(long adtypeid) {
        return find("adtypeid", adtypeid).fetch(50);
    }
	
    //根据 adname 查找
	public static List<AdTemp> findByAdname(String adname) {
        return find("adname", adname).fetch(50);
    }

    //根据 advertiserid 查找
	public static List<AdTemp> findByAdvertiserid(long advertiserid) {
